const t = () => {
    ...
    return{id:"mathjax2",init:function(a){t = a;
                                          let n = t.getConfig().mathjax2 || t.getConfig().math || {},
                                              i = {...e,...n},
                                              s = (i.mathjax || "https://cdn.jsdelivr.net/npm/mathjax@2/MathJax.js") + "?config=" + (i.config || "TeX-AMS_HTML-full");
                                          i.tex2jax = {...e.tex2jax,...n.tex2jax},
                                              ...
                                              n.onload = i,
                                                  n.onreadystatechange = () => {"loaded" === this.readyState && i()},
                                                  a.appendChild(n)}
                                          (s,(function() {
        ...
        return{id:"katex",init:function(n)
               {t = n;
                ...
                (t => {
                    ...
                    async function(t) {
                    for(const e of t)await a(e)}(m).then((() => {
        ...
        let t,e = {
            ...
            startup:{ready:() => {
                MathJax.startup.defaultReady(),
                    ...
                    Reveal.layout()}))}}};
        return{id:"mathjax3",init:function(a) {
            t = a;
