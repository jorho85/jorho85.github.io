    ...
    return Plugin = Object.assign(e(),{KaTeX:() => {
        ...
        return {
            ...
            init: function(a) {
                ...
                (t => { let e = document.createElement("link");
                       e.rel="stylesheet",
                           e.href = t,
                           document.head.appendChild(e)})(p),
                    async function(t) {
                    for(const e of t)await n(e)}(m).then((() => {
                                       ...
                                       MathJax3: () => {
                                           ...
                                           return {
                                               ...
                                               init: function(n) {
                                                   ...
                                                   (s,(function() {
                                                       Reveal.addEventListener("slidechanged",(function(t){MathJax.typeset()}))}))}}}})}));